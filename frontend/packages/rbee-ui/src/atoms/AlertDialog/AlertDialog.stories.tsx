    ...
    <AlertDialog>
      ...
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>Please type "DELETE" to confirm this destructive action.</AlertDialogDescription>
        </AlertDialogHeader>
        <input type="text" placeholder="Type DELETE" className="border rounded px-3 py-2 text-sm" />
        <AlertDialogFooter>
          <AlertDialogCancel>Cancel</AlertDialogCancel>
