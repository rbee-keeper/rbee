    ...
    children: (
      <>
        <div className="space-y-2">
          <h3 className="text-2xl md:text-3xl font-semibold tracking-tight text-card-foreground">Feature Title</h3>
  ...
  args: {
    children: (
      <>
        ...
        <p className="text-base md:text-lg text-muted-foreground">
          Drop-in for Zed, Cursor, Continue, or any OpenAI client. Keep your SDKs and prompts—just change the base URL.
        </p>
...
export const WithMultipleSections: Story = {
  args: {
    children: (
      <>
        <div className="space-y-2">
          <h3 className="text-2xl md:text-3xl font-semibold tracking-tight text-card-foreground">Complex Feature</h3>
