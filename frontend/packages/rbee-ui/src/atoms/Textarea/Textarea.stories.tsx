  ...
  render: () => (
    <div className="flex flex-col gap-6 w-full max-w-md">
      ...
      <div className="space-y-2">
        ...
        <Textarea placeholder="This textarea has a fixed height..." className="resize-none h-32" />
      ...
      <div className="space-y-2">
        ...
        <Textarea placeholder="You can resize this vertically..." className="resize-y min-h-24" />
  ...
  render: () => (
    <div className="flex flex-col gap-4 w-full max-w-md">
      ...
      <div className="space-y-2">
        ...
        <Textarea placeholder="This is disabled..." disabled value="This content cannot be edited" />
      </div>
    </div>
  ),
}
  ...
  render: () => (
    <form className="w-full max-w-2xl space-y-6 p-6 border rounded">
      ...
      <div className="space-y-2">
        ...
        <Textarea required placeholder="Tell us what you think..." className="min-h-32" />
      ...
      <div className="space-y-2">
        ...
        <Textarea placeholder="Any other information you'd like to share..." className="min-h-24" />
      </div>
