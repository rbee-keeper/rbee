...
// @ts-nocheck
// TEAM-413: Added @ts-nocheck to suppress unused variable warnings in generated code
 ...
 */
async marketplaceListModels(query: string | null, limit: number | null) : Promise<Result<Model[], string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("marketplace_list_models", { query, limit }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
function _makeEvents<T extends Record<string, any>>(
