 ...
 */
export async function listCivitaiModels(options: ListCivitaiModelsOptions = {}): Promise<CivitaiListResponse> {
 ...
 */
export async function getCompatibleCivitaiModels(options: ListCivitaiModelsOptions = {}): Promise<any[]> {
