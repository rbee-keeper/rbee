...
**Start here:** [Getting started: single machine](/getting-started/single-machine) or [Getting started: homelab](/getting-started/homelab)
...
**Start here:** [Getting started: GPU providers](/getting-started/gpu-providers) or See [Premium Modules](/reference/premium-modules) for advanced routing, telemetry, and GDPR-focused auditing (€129-€499 one-time, planned for M2 launch Q2 2026).
...
**Start here:** [Getting started: academic & research](/getting-started/academic) or [GDPR & compliance](/reference/gdpr-compliance)

## Quickstart paths

- **[Single machine setup](/getting-started/single-machine)** - Run rbee on one computer with one or more GPUs
- **[Multi-machine homelab](/getting-started/homelab)** - Connect multiple machines into one unified system
- **[GPU provider platform](/getting-started/gpu-providers)** - Build an API product from your GPU fleet
- **[Licensing & premium modules](/reference/licensing)** - Understand what's free vs premium
...
**Learn more:** [Architecture overview](/architecture/overview)
...
**Learn more:** [Licensing details](/reference/licensing) or [Premium modules overview](/reference/premium-modules)

## Where to go next

1. **[Install rbee](/getting-started/installation)** - Download and set up the base system
2. **[Run your first colony](/getting-started/single-machine)** - Get a single-machine setup working
3. **[Scale to multiple machines](/getting-started/homelab)** - Connect your devices into one system
4. **[Use the OpenAI-compatible API](/reference/api-openai-compatible)** - Integrate rbee into your applications
5. **[Understand GDPR & auditing](/reference/gdpr-compliance)** - Learn about compliance features
