# PKGBUILD for llm-worker-rbee (binary/release version)
...
pkgname=llm-worker-rbee-bin
pkgver=0.1.0
pkgrel=1
pkgdesc="LLM worker for rbee system (pre-built binary)"
arch=('x86_64' 'aarch64')
url="https://github.com/rbee-keeper/rbee"
license=('GPL-3.0-or-later')
provides=('llm-worker-rbee')
conflicts=('llm-worker-rbee-git')
...
source=("https://github.com/rbee-keeper/rbee/releases/download/v${pkgver}/llm-worker-rbee-${_platform}-${pkgver}.tar.gz")
sha256sums=('SKIP')
