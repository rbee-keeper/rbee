  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-[size=default]:min-h-[2.75rem] data-[size=sm]:min-h-[2.25rem]",
        ...
        "disabled:bg-[#1a2435] disabled:text-[#6c7a90] disabled:border-[#223047] disabled:data-[placeholder]:text-[#6c7a90]",
        focusRing,
