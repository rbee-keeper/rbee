// TEAM-463: HuggingFace model details page - Separated from generic ModelDetailsPage
// Created by: TEAM-463
...
export function ModelDetailsHuggingFacePage() {
  ...
  const {
    ...
    queryKey: ['marketplace', 'huggingface', 'model', modelId],
    queryFn: async () => {
  ...
  // Build compatible workers array for template
      ...
      <PageContainer title="Model Not Found" description="The requested model could not be found" padding="default">
        <Card>
          <CardContent className="p-12 text-center">
            ...
            <Button onClick={() => navigate('/marketplace/huggingface')}>
              <ArrowLeft className="size-4 mr-2" />
              Back to HuggingFace Models
            </Button>
          </CardContent>
        </Card>
      </PageContainer>
