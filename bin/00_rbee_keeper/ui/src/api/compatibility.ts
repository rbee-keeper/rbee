 ...
 * ```
 */
export async function checkModelCompatibility(modelId: string, workerType: string): Promise<CompatibilityResult> {
 ...
 * ```
 */
export async function listCompatibleWorkers(modelId: string): Promise<string[]> {
 ...
 * ```
 */
export async function listCompatibleModels(workerType: string, limit?: number): Promise<string[]> {
