...
export const Default: Story = {
  args: {
    ...
    price: '€299',
    period: '/month',
    features: ['Up to 10 workers', '100k requests/month', 'Email support', '99.9% uptime SLA'],
...
export const InPricingContext: Story = {
  render: () => (
    <div className="w-full max-w-6xl">
      <div className="mb-4 text-sm text-muted-foreground">Example: PricingTier in PricingSection organism</div>
      <div className="grid gap-6 md:grid-cols-3">
        <PricingTier
          title="Starter"
          price="€99"
          period="/month"
          features={['Up to 3 workers', '10k requests/month', 'Community support', '99% uptime SLA']}
          ctaText="Start Free Trial"
          ctaHref="/signup"
          ctaVariant="outline"
  ...
  parameters: {
    docs: {
      description: {
        story:
          'PricingTier as used in the PricingSection organism, showing three pricing tiers with the middle one highlighted.',
      },
    },
  },
}
