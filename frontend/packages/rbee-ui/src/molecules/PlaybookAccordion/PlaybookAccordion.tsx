...
export function PlaybookItem({
  ...
  return (
    <details ref={detailsRef} className="group border-b border-border last:border-b-0 font-sans">
      <summary
...
export function SeverityLegend() {
  return (
    <div
      className="flex items-center gap-4 px-5 py-2 bg-muted/30 border-b border-border/50 text-xs font-sans"
      role="note"
...
export function PlaybookHeader({
  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 px-5 py-4 border-b border-border font-sans">
