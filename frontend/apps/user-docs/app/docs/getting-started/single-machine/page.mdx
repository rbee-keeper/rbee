...
```bash
# Start the queen on default port (8500)
queen-rbee start

# Or specify a custom port
queen-rbee start --port 8600
```
...
rbee-hive start --queen-url http://localhost:8500
```
...
🐝 Registered with queen at http://localhost:8500
```
