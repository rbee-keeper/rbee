...
const meta: Meta<typeof BulletListItem> = {
  title: 'Molecules/BulletListItem',
    ...
    <div className="flex flex-col gap-8 p-8 max-w-2xl">
      ...
      <div className="flex flex-col gap-4">
        ...
        <ul className="space-y-3">
          ...
          <BulletListItem title="Arrow with meta" meta="2 min" variant="arrow" color="primary" />
        </ul>
      </div>
    </div>
  ),
  ...
  render: () => (
    <div className="flex flex-col gap-4 p-8 max-w-2xl bg-chart-3 rounded">
      ...
      <ul className="space-y-3">
        ...
        />
        <BulletListItem
          title="Confidentiality (C1.1-C1.2)"
          variant="check"
          showPlate={false}
          color="white"
          className="text-white"
...
export const MutedCheckmarks: Story = {
  render: () => (
    <div className="flex flex-col gap-4 p-8 max-w-2xl">
      ...
      <ul className="space-y-3">
        <BulletListItem
          title="GET /v2/compliance/data-access"
          variant="check"
          showPlate={false}
          color="muted"
        ...
        />
        <BulletListItem
          title="POST /v2/compliance/data-export"
          variant="check"
          showPlate={false}
          color="muted"
          className="text-muted-foreground/50"
        />
        <BulletListItem
          title="POST /v2/compliance/data-deletion"
          variant="check"
          showPlate={false}
          color="muted"
          className="text-muted-foreground/50"
        />
        <BulletListItem
          title="GET /v2/compliance/audit-trail"
          variant="check"
          showPlate={false}
          color="muted"
          className="text-muted-foreground/50"
