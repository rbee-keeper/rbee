    ...
    <RadioGroup defaultValue="standard" className="gap-4">
      <div className="flex items-start gap-3">
        ...
        <div className="grid gap-1.5 leading-none">
          <label htmlFor="plan-standard" className="text-sm font-medium leading-none cursor-pointer">
            Standard Plan
          </label>
          <p className="text-sm text-muted-foreground">Perfect for small teams. Up to 10 users, 100GB storage.</p>
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="grid gap-1.5 leading-none">
          ...
          <p className="text-sm text-muted-foreground">For growing businesses. Up to 50 users, 500GB storage.</p>
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="grid gap-1.5 leading-none">
          <label htmlFor="plan-enterprise" className="text-sm font-medium leading-none cursor-pointer">
            Enterprise Plan
          </label>
          <p className="text-sm text-muted-foreground">Unlimited users and storage. Dedicated support and SLA.</p>
        ...
        <RadioGroup defaultValue="auto">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="grid gap-1 leading-none">
              ...
              <p className="text-xs text-muted-foreground">Maintain constant number of instances</p>
            </div>
          </div>
        </RadioGroup>
      </div>
