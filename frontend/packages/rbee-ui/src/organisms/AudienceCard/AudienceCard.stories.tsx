...
export const Enterprise: Story = {
  args: {
    ...
    features: ['Full data sovereignty and compliance', 'Dedicated support and SLAs', 'Custom deployment options'],
    href: '/enterprise',
...
export const OriginalVsNew: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          'Side-by-side comparison of the original AudienceCard design vs the new refactored version with Card atom and ButtonCardFooter.',
      },
    },
  },
}
